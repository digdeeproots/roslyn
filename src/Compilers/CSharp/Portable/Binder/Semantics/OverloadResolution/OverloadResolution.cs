    ...
    internal sealed partial class OverloadResolution
    {
            ...
            where TMember : Symbol
        {
            for (int comparedToCandidateIndex = 0; comparedToCandidateIndex < results.Count; comparedToCandidateIndex++)
            {
                ...
                {
                    analysis.StoreAsWorseThanSomething(candidateIndex);
            ...
            where TMember : Symbol
        {
            for (int i = 0; i < analysis.Count; ++i)
            {
                ...
                {
                    Debug.Assert(!analysis.IsNotBetterThanEverything(i) || i == goodCandidate);
                }
            }

            Debug.Assert(analysis[goodCandidate] == NotBetterThanEverything);
            results[goodCandidate] = results[goodCandidate].Worse();
        }
        ...
        private static void MarkAllOtherCandidatesAsWorse<TMember>(
        ...
        public const int NotBetterThanEverything = 2;
