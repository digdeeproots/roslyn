...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class OverloadResolution
    {
            ...
            where TMember : Symbol
        {
            ...
            {
                probably_WhenNoNotBestCandidates_DoTheRigthThing(results, worse, unknown, worseThanSomething);
            }
        ...
        private static void probably_WhenNoNotBestCandidates_DoTheRigthThing<TMember>(ArrayBuilder<MemberResolutionResult<TMember>> results, ArrayBuilder<int> worse,
